  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col px-5 py-8">
      ...
      <section className="grid gap-3 py-5">
        ...
        <p className="text-center text-xs font-semibold text-brand-muted">Demo logins: learner@bridgeup.sg, mentor@bridgeup.sg, staff@bridgeup.sg, admin@bridgeup.sg · BridgeUp123!</p>
      </section>
    </main>
  );
}
